# Your stdlib service: csillag/memory
...
example, `csillag/memory/remember` would map to the first
...
The entry point to your function described in `f/remember/function.json`.
